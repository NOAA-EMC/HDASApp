...
# JEDI data
datapath = "./"
janalysis = f"{datapath}/Data/analysis/envar-fv3_hafs_singleOBS_sfcshp.fv_core.res.nc"
...
oberr_final = jncdiag.groups["EffectiveError1"].variables[f"{variable}"][:][0]
...
if plot_var == "Increment":
    plt.savefig(f"./fv3jedi_vs_gsi_increment_{obtype}_{variable}_lvl{lev}.png", dpi=250, bbox_inches='tight')
if plot_var == "Diff":
    plt.savefig(f"./fv3jedi_vs_gsi_difference_{obtype}_{variable}_lvl{lev}.png", dpi=250, bbox_inches='tight')
